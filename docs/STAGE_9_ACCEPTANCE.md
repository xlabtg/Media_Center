...
сервисных образов в GHCR. Остальные эпики Этапа 9 ведутся отдельными
родительскими issue из плана #213.
...
Сквозной контракт эпика закреплён в
...
```bash
python -m pytest tests/test_stage9_epic_c_issue241_contract.py
```
