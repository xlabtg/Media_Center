...
Причина превышения: текущий `infra/docker/service.Dockerfile` устанавливает весь
общий список `[project].dependencies` из `pyproject.toml` в каждый сервисный
образ. Для достижения бюджета нужно разделить runtime-зависимости по сервисам
или ввести другой slim-механизм сборки без тяжелых неиспользуемых пакетов.
