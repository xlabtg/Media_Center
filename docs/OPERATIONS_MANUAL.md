...
[MINIMAL_PRODUCTION_RESOURCES.md](MINIMAL_PRODUCTION_RESOURCES.md),
...
| Минимальный production capacity | [MINIMAL_PRODUCTION_RESOURCES.md](MINIMAL_PRODUCTION_RESOURCES.md) | Первый tenant, проверка CPU/RAM, запуск только recommended-core сервисов |
...
- [ ] Capacity floor из `docs/MINIMAL_PRODUCTION_RESOURCES.md` подтвержден для
      профиля `nmc-minimal-100upm`.
