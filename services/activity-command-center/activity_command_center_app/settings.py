...
from activity_command_center import ACTIVITY_COMMAND_CENTER_SERVICE_NAME
...
def build_service_config(
    ...
    *,
    ...
    values = resolve_config_values(
        raw_values,
        application=ACTIVITY_COMMAND_CENTER_SERVICE_NAME,
    ...
    return ServiceTemplateConfig(
        service_name=_env(
            values,
            "SERVICE_NAME",
            default=ACTIVITY_COMMAND_CENTER_SERVICE_NAME,
        ),
