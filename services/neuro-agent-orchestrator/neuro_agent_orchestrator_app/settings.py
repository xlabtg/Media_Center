...
from neuro_agent_orchestrator import NEURO_AGENT_ORCHESTRATOR_SERVICE_NAME
...
def build_service_config(
    ...
    *,
    ...
    values = resolve_config_values(
        raw_values,
        application=NEURO_AGENT_ORCHESTRATOR_SERVICE_NAME,
    ...
    return ServiceTemplateConfig(
        service_name=_env(
            values,
            "SERVICE_NAME",
            default=NEURO_AGENT_ORCHESTRATOR_SERVICE_NAME,
        ),
